package com.dbdou.arts.easy.url.util;
...
public class MurmurHash {
    ...
    public static int hash32(CharSequence data) {
        return hash32(data.toString().getBytes(DEFAULT_CHARSET));
    }
    ...
    public static long hash64(CharSequence data) {
        return hash64(data.toString().getBytes(DEFAULT_CHARSET));
    }
    ...
    public static long[] hash128(CharSequence data) {
        return hash128(data.toString().getBytes(DEFAULT_CHARSET));
    }
